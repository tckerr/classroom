...
export class GameSummaryAccessor {
  ...
  public get gameId(){ return this.gameSummary.publicData.gameId; }
  public get stageType(){ return this.gameSummary.publicData.stageType; }
  public get phaseType(){ return this.gameSummary.publicData.phaseType; }
